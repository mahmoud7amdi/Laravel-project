                        ...
                        <div class="card-body">
                           ...
                           <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                               ...
                               <div class="row mb-3">
                                   <label for="example-text-input" class="col-sm-2 col-form-label">UserName</label>
                                   <div class="col-sm-10">
                                       <img id="showImage" class="rounded-circle avatar-xl" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/No_Image_Available.jpg') }}" alt="Card image cap">                                </div>
                               </div>
                               <!-- end row -->
