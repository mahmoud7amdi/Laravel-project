                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.protfolio') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="protfolio_name" class="form-control" type="text"  id="example-text-input" value="{{  $protfolio->protfolio_name }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="protfolio_title" class="form-control" type="text" value="{{  $protfolio->protfolio_title }}" id="example-text-input">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea required="" name="protfolio_description"> {{  $protfolio->protfolio_description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-xl" src="{{  $protfolio->protfolio_image  }}" alt="Card image cap">                                </div>
                                </div>
                                <!-- end row -->
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Protfolio">
