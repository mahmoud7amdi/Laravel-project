                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.blog') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_tags" value=value="{{ $blogs->blog_tags }}" data-role="tagsinput" class="form-control" type="text" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea required="" name="blog_description" >{{ $blogs->blog_description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-xl" src="{{ asset($blogs->blog_image) }}" alt="Card image cap">                                </div>
                                </div>
