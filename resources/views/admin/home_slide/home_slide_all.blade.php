                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-xl" src="{{ (!empty($homeslide->home_slide))? url('upload/home_slide/'.$homeslide->home_slide):url('upload/No_Image_Available.jpg') }}" alt="Card image cap">                                </div>
                                </div>
                                <!-- end row -->
